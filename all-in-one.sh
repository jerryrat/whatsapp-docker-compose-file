...
if docker ps -a --format '{{.Names}}' | grep -q "^$CONTAINER_NAME$"; then
  echo -e " ${Green_font_prefix}n8n安装成功${Font_color_suffix} 请访问 ${Green_font_prefix}http://$current_ip:5678/${Font_color_suffix} 进行更多设置，注意是${Green_font_prefix}http${Font_color_suffix} 不是${Green_font_prefix}https${Font_color_suffix}"
